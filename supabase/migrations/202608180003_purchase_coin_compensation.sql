-- Compensación automática de monedas para Compras desde Caja Central.
-- Migración aditiva: revisar y aplicar manualmente después de
-- 202608170001_purchases.sql.
...
comment on function public.create_paid_purchase(
  ...
  'Crea una Compra idempotente y compensa automáticamente sus monedas cuando se paga desde Caja Central.';
